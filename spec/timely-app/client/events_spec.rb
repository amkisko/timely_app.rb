...
RSpec.describe TimelyApp::Client do
  ...
  describe "#create_event" do
    it TimelyApp::TestLiterals::RETURNS_A_RECORD do
      ...
      expect(client.create_event(day: TimelyApp::TestLiterals::EVENT_DAY, hours: 1, minutes: 30)).to be_instance_of(TimelyApp::Record)
    end
  end
  ...
  describe "#create_project_event" do
    it TimelyApp::TestLiterals::RETURNS_A_RECORD do
      ...
      expect(client.create_project_event(project_id: id, day: TimelyApp::TestLiterals::EVENT_DAY, hours: 1, minutes: 30)).to be_instance_of(TimelyApp::Record)
    end
  end
  ...
  describe "#create_user_event" do
    it TimelyApp::TestLiterals::RETURNS_A_RECORD do
      ...
      expect(client.create_user_event(user_id: id, day: TimelyApp::TestLiterals::EVENT_DAY, hours: 1, minutes: 30)).to be_instance_of(TimelyApp::Record)
    end
  end
  ...
  describe "#get_events" do
    ...
    it TimelyApp::TestLiterals::ENCODES_PARAMS do
      expect_request(:get, "#{base_url}/1.1/#{account_id}/events?day=#{TimelyApp::TestLiterals::EVENT_DAY}")

      client.get_events(day: TimelyApp::TestLiterals::EVENT_DAY)
    end
  end
  ...
  describe "#get_project_events" do
    ...
    it TimelyApp::TestLiterals::ENCODES_PARAMS do
      expect_request(:get, "#{base_url}/1.1/#{account_id}/projects/#{id}/events?day=#{TimelyApp::TestLiterals::EVENT_DAY}")

      client.get_project_events(project_id: id, day: TimelyApp::TestLiterals::EVENT_DAY)
    end
  end
  ...
  describe "#get_user_events" do
    ...
    it TimelyApp::TestLiterals::ENCODES_PARAMS do
      expect_request(:get, "#{base_url}/1.1/#{account_id}/users/#{id}/events?day=#{TimelyApp::TestLiterals::EVENT_DAY}")

      client.get_user_events(user_id: id, day: TimelyApp::TestLiterals::EVENT_DAY)
    end
  end
  ...
  describe "#update_user_event" do
    it TimelyApp::TestLiterals::RETURNS_A_RECORD do
      ...
      expect(client.update_user_event(id, user_id: id, day: TimelyApp::TestLiterals::EVENT_DAY, hours: 2, minutes: 0)).to be_instance_of(TimelyApp::Record)
    end
  end
  ...
  describe "#update_project_event" do
    it TimelyApp::TestLiterals::RETURNS_A_RECORD do
      ...
      expect(client.update_project_event(id, project_id: id, day: TimelyApp::TestLiterals::EVENT_DAY, hours: 2, minutes: 0)).to be_instance_of(TimelyApp::Record)
    end
  end
  ...
  describe "#update_event" do
    it TimelyApp::TestLiterals::RETURNS_A_RECORD do
      ...
      expect(client.update_event(id, day: TimelyApp::TestLiterals::EVENT_DAY, hours: 2, minutes: 0)).to be_instance_of(TimelyApp::Record)
    end
  end
